...
(in terminal):
➜  02_sql_crud_lab psql
psql (13.2)
Type "help" for help.

milludaltcasa=# \l
milludaltcasa=# \c marvel
You are now connected to database "marvel" as user "milludaltcasa".
...
marvel=# SELECT * FROM people WHERE id = 1;
 id |     name      
----+---------------
  1 | Homer Simpson
(1 row)
...
marvel=# INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2018, '21:30');
INSERT 0 1
marvel=# SELECT * FROM movies;
 id |                title                | year | show_time 
----+-------------------------------------+------+-----------
 ...
 18 | Thor: Ragnarok                      | 2017 | 22:10
 19 | Black Panther                       | 2018 | 21:00
 20 | Avengers: Infinity War              | 2018 | 21:30
(19 rows)

9.  The cinema would like to make the Iron Man movies a triple billing. Find out the show time of "Iron Man 2" and set the show time of "Iron Man 3" to start two hours later.

marvel=# UPDATE movies SET show_time = '23:55' WHERE title = 'Iron Man 3';
UPDATE 1
marvel=# SELECT * FROM movies;
 id |                title                | year | show_time 
----+-------------------------------------+------+-----------
...
(from https://stackoverflow.com/questions/16029441/how-to-delete-multiple-rows-in-sql-where-id-x-to-y/16029501)
